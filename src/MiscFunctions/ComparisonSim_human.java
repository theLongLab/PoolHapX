...
public class ComparisonSim_human {
...
// 
	...
	public ComparisonSim_human(String parm ) throws IOException {
...
//							+ "programs/PoolSimulator_SLiM.jar\n");
						bw.write("poolsim=/export/qlong/PoolHapX/PoolSimulator_SLiM_human.jar\n");
					} else{
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		ComparisonSim_human cs = new ComparisonSim_human(args[0]);
