...
// 
	...
	String species= "bacteria"; //virus, bacteria, metagenomics, human
	
	
	public ComparisonSim(String parm ) throws IOException {
	...
	//				slim=/home/jingni.he1/download/SliM/build/slim
					...
					if (!species.equals("bacteria")) {
						bw.write("poolsim=/export/qlong/PoolHapX/PoolSimulator_SLiM.jar\n");
					} else{
						bw.write("poolsim=/export/qlong/PoolHapX/PoolSimulator_SLiM_bacterial.jar\n");
					}
	...
	//	Step 5. Convert each pool-specific BAM file to SAM (i.e.: text), then VEF files.	
					...
					bw_properties.write("Regression_Regional_HapSetSize_Max = 20\n");
					...
					bw_properties.write("Species = bacteria\n");	 
					bw_properties.close();
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		ComparisonSim cs = new ComparisonSim(args[0]);
