...
public class ComparisonSim_1000G_THUMPD1P1 {
...
// 
	int genome_len = 101919 ;
	String genome_path ="/export/qlong/chencao/Work/poolhapx/slim/1000G/ref/THUMPD1P1/THUMPD1P1.fa"; 
	String species= "human"; //virus, bacteria, metagenomics, human
	
	
	public ComparisonSim_1000G_THUMPD1P1(String parm ) throws IOException {
...
//							+ "programs/PoolSimulator_SLiM.jar\n");
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		ComparisonSim_1000G_THUMPD1P1 cs = new ComparisonSim_1000G_THUMPD1P1(args[0]);
