...
public class ComparisonSim_metagenomics {
...
// 
	int genome_len = 4972;
	String genome_path ="/gpfs/qlong/chencao/Work/poolhapx/slim/ref/ecoli/ecoli.fa"; 
	String species= "metagenomics"; //virus, bacteria, metagenomics, human
	
	
	public ComparisonSim_metagenomics(String parm ) throws IOException {
...
//							+ "programs/PoolSimulator_SLiM.jar\n");
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		ComparisonSim_metagenomics cs = new ComparisonSim_metagenomics(args[0]);
