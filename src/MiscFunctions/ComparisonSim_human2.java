...
public class ComparisonSim_human2 {
...
// 
	int genome_len = 91193;
	String genome_path ="/export/qlong/chencao/Work/poolhapx/slim/ref/human/brca2.fa"; 
	String species= "human"; //virus, bacteria, metagenomics, human
	
	
	public ComparisonSim_human2(String parm ) throws IOException {
...
//							+ "programs/PoolSimulator_SLiM.jar\n");
						bw.write("poolsim=/export/qlong/PoolHapX/PoolSimulator_SLiM_human2.jar\n");
					} else{
	...
	//				PoolSimulator_SLiM.jar "$1"/input/PoolSimulator.properties
					...
					bw.write("cp  "+ this.prefix_folder + "island_diploid.out "
	...
	//	Step 5. Convert each pool-specific BAM file to SAM (i.e.: text), then VEF files.	
					...
					bw_properties.write("Regression_One_Vector_Weight = 15.0 \n");
					...
					bw_properties.write("Species = human\n");	 
					bw_properties.close();
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		ComparisonSim_human2 cs = new ComparisonSim_human2(args[0]);
